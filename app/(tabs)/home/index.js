...
const index = () => {
  ...
  const suggestions = [
    {
      id: "0",
      todo: "Take kid to class",
    },
    {
      id: "1",
      todo: "Take kid Excercising",
    },
    {
      id: "2",
  ...
  const addTodo = async () => {
    try {
      ...
      axios
        .post(configrations.baseUrl+"todos/664471d0e297cde289d13d89", todoData)
        .then((response) => {
  ...
  const getUserTodos = async () => {
    try {
      const response = await axios.get(
        configrations.baseUrl+`users/664471d0e297cde289d13d89/todos`
      );
  ...
  const markTodoAsCompleted = async (todoId) => {
    try {
      ...
      const response = await axios.patch(
        configrations.baseUrl+`todos/${todoId}/complete`
      );
    ...
    <>
      ...
      >
        ...
        <Pressable onPress={() => setModalVisible(!isModalVisible)}>
          <AntDesign name="pluscircle" size={30} color="#47c681" />
        </Pressable>
      </View>
                ...
                <View>
                  ...
                  >
                    <Image
                      ...
                      source={{
                        uri: "https://planhop.com/bites/images/done.gif",
                      }}
                    />
                  </View>
      ...
      >
        <ModalContent style={{ width: "100%", height: 280 }}>
          ...
          >
            ...
            />
            <Ionicons onPress={addTodo} name="send" size={24} color="#47c681" />
          </View>
